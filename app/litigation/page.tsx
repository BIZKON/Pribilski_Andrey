        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <div className="space-y-6">
            {[
              ...
              { title: "Палата по патентным спорам (ППС)", desc: "Оспаривание отказов в регистрации ТЗ. Подача возражений против предоставления правовой охраны товарным знакам и патентам конкурентов." },
      ...
      <section className="py-24 glass-panel relative">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          <div className="glass-card p-8 md:p-12 rounded-3xl border border-gold-main/20 shadow-2xl">
            <h2 className="text-3xl font-sans font-bold mb-2 text-center">Запросить оценку перспектив дела</h2>
            <p className="text-text-muted text-center mb-8">Опишите вашу ситуацию, и наши юристы бесплатно оценят шансы на успех.</p>
            ...
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-sm font-medium text-text-muted">Суть спора</label>
                <textarea id="message" rows={4} className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-text-main focus:outline-none focus:border-gold-main transition-colors resize-none" placeholder="Кратко опишите, что произошло (кто нарушил, что нарушил, есть ли претензия)"></textarea>
              </div>
              <Button type="button" size="lg" className="w-full">
                Получить оценку <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </form>
          </div>
        </div>
